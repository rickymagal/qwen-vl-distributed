...
int main(int argc, char** argv) {
  ...
  qwen::require(out.hidden_out.defined(), "stage3: hidden_out undefined");
  qwen::require_cuda(out.hidden_out, "stage3: hidden_out must be CUDA");

  std::printf("stage3 sanity forward ok (hidden_out=%s)\n", out.hidden_out.sizes().str().c_str());
  return 0;
}
